...
public class Key : MonoBehaviour {
	...
	private RectTransform wallOneRect;
	private GameObject dividerOne;
	...
	void Start () {
		...
		dividerOne = GameObject.Find ("Divider One");
		...
		wallOneRect = wallOne.GetComponent<RectTransform> ();
	...
	void On_TouchUp (Gesture gesture){
		...
		if (fingerId == gesture.fingerIndex) {
			...
			if (gesture.IsOverRectTransform (wallOneRect, Camera.main) == true) {
	...
	private IEnumerator Destroy(){
		dividerOne.GetComponent<Collider> ().enabled = false;
		unlocking.Play ();
